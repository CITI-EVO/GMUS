...
{
    public partial class MonitoringStatusControl : BaseUserControlExtend<MonitoringStatusModel>
    {
        ...
        public override MonitoringStatusModel GetModel()
        {
        ...
        public override void SetModel(MonitoringStatusModel model)
        {
