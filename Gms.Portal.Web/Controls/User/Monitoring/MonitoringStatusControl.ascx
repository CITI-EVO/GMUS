<%@ Control Language="C#" AutoEventWireup="true" CodeFile="MonitoringStatusControl.ascx.cs" Inherits="Gms.Portal.Web.Controls.User.Monitoring.MonitoringStatusControl" %>

<%@ Register TagPrefix="local" TagName="HiddenFieldValueControl" Src="~/Controls/Common/HiddenFieldValueControl.ascx" %>

<local:HiddenFieldValueControl runat="server" ID="hdID" Property="{MonitoringStatusModel.RecordID=Value}" />

<div class="form-group">
    <ce:Label runat="server" CssClass="col-lg-2 control-label">Status</ce:Label>
    <div class="col-lg-10">
        <ce:DropDownList runat="server" ID="cbxStatus" DataTextField="Name" DataValueField="ID" Property="{MonitoringStatusModel.Status=SelectedValue}" CssClass="chosen-select" AutoPostBack="True">
            <Items>
...
<asp:Panel runat="server" CssClass="form-group" ID="pnlExpireDate">
    ...
    <div class="col-lg-10">
        <div class="input-group date">
            ...
            <asp:TextBox runat="server" ID="tbxExpireDate" CssClass="form-control" Property="{MonitoringStatusModel.ExpireDate=Text}"></asp:TextBox>
        </div>
    </div>
</asp:Panel>
<div class="form-group">
    ...
    <div class="col-lg-10">
        <asp:TextBox runat="server" ID="tbxComment" Property="{MonitoringStatusModel.Comment=Text}" TextMode="MultiLine" CssClass="form-control"></asp:TextBox>
    </div>
</div>
