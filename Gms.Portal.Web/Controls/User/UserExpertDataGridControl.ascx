<%@ Control Language="C#" AutoEventWireup="true" CodeFile="UserExpertDataGridControl.ascx.cs" Inherits="Gms.Portal.Web.Controls.User.UserExpertDataGridControl" %>
            ...
            <ItemTemplate>
                <div class="dropdown">
                    ...
                    <div class="dropdown-content">
                        ...
                        <asp:HyperLink runat="server" ID="btnScores" ToolTip="Change scores" NavigateUrl='<%# GetChangeScoresUrl(Container.DataItem) %>' Visible='<%# GetScoresVisible(Container.DataItem) %>' CommandArgument='<%# GetCommandArg(Container.DataItem) %>' OnCommand="btnScores_OnCommand" CssClass="btn btn-warning btn-sm fa fa-cog" />
