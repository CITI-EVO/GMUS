...
<asp:Panel runat="server" ID="pnlElementType" CssClass="form-group">
    <ce:Label runat="server" CssClass="col-sm-2 control-label">Element Type</ce:Label>
    <div class="col-lg-10">
...
<asp:Panel runat="server" ID="pnlMandatory" CssClass="form-group">
    <ce:Label runat="server" CssClass="col-sm-2 control-label">Mandatory</ce:Label>
    <div class="col-lg-10">
...
<asp:Panel runat="server" ID="pnlPrivacy" CssClass="form-group">
    <ce:Label runat="server" CssClass="col-sm-2 control-label">Privacy</ce:Label>
    <div class="col-lg-10">
...
<asp:Panel runat="server" ID="pnlGroupAlign" CssClass="form-group">
    <ce:Label runat="server" CssClass="col-sm-2 control-label">Group Size</ce:Label>
    <div class="col-lg-10">
...
<asp:Panel runat="server" ID="pnlType" CssClass="form-group">
    <ce:Label runat="server" CssClass="col-sm-2 control-label">Control Type</ce:Label>
    <div class="col-lg-10">
...
<asp:Panel runat="server" ID="pnlMask" CssClass="form-group">
    <ce:Label runat="server" CssClass="col-sm-2 control-label">Mask</ce:Label>
    <div class="col-lg-10">
...
<asp:Panel runat="server" ID="pnlEnabled" CssClass="form-group">
    <ce:Label runat="server" CssClass="col-sm-2 control-label">Enabled</ce:Label>
    <div class="col-lg-10">
...
<asp:Panel runat="server" ID="pnlDisplayOnGrid" CssClass="form-group">
    <ce:Label runat="server" CssClass="col-sm-2 control-label">Display On Grid</ce:Label>
    <div class="col-lg-10">
...
<asp:Panel runat="server" ID="pnlValidationExp" CssClass="form-group">
    <ce:Label runat="server" CssClass="col-sm-2 control-label">ValidationExp</ce:Label>
    <div class="col-lg-10">
...
<asp:Panel runat="server" ID="pnlTag" CssClass="form-group">
    <ce:Label runat="server" CssClass="col-sm-2 control-label">Tag</ce:Label>
    <div class="col-lg-10">
...
<asp:Panel runat="server" ID="pnlDataSource" CssClass="form-group">
    <ce:Label runat="server" CssClass="col-sm-2 control-label">Data Source</ce:Label>
    <div class="col-lg-10">
...
<asp:Panel runat="server" ID="pnlTextExpression" CssClass="form-group">
    <ce:Label runat="server" CssClass="col-sm-2 control-label">Text Expression</ce:Label>
    <div class="col-lg-10">
...
<asp:Panel runat="server" ID="pnlValueExpression" CssClass="form-group">
    <ce:Label runat="server" CssClass="col-sm-2 control-label">Value Expression</ce:Label>
    <div class="col-lg-10">
