<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="FullExpertDataGrid.aspx.cs" Inherits="Gms.Portal.Web.Pages.User.FullExpertDataGrid" %>

<%@ Register TagPrefix="local" TagName="UserMessageControl" Src="~/Controls/User/UserMessageControl.ascx" %>
<%@ Register TagPrefix="local" TagName="FullExpertDataGridControl" Src="~/Controls/User/FullExpertDataGridControl.ascx" %>
    ...
    <div>
        ...
        <div class="ibox float-e-margins">
            <div class="ibox float-e-margins">
                <div class="ibox-content">
                    <div class="form-group">
                        <local:FullExpertDataGridControl runat="server" ID="fullExpertDataGridControl" OnMessage="fullExpertDataGridControl_OnMessage" OnAccept="fullExpertDataGridControl_OnAccept" OnReject="fullExpertDataGridControl_OnReject" />
                    </div>
                </div>
            </div>
        </div>
