            ...
            <Columns>
                <asp:TemplateField>
                    <ItemTemplate>
                        ...
                        <ce:LinkButton ID="btnNewMessage" runat="server" CssClass="btn btn-info btn-sm fa fa-plus-circle" ToolTip="მესიჯის დამატება" CommandArgument='<% #Eval("ID")%>' OnCommand="btnNewMessage_OnCommand" />
                        ...
                        <ce:LinkButton ID="btnSetAttribute" runat="server" CssClass="btn btn-info btn-sm fa fa-plus-circle" ToolTip="ატრიბუტების დამატება" CommandArgument='<% #Eval("ID")%>' OnCommand="btnSetAttribute_OnCommand" />
                        <ce:LinkButton ID="btnViewAttributes" runat="server" CssClass="btn btn-primary btn-sm fa fa-search" ToolTip="ატრიბუტების ნახვა" CommandArgument='<% #Eval("ID")%>' OnCommand="btnViewAttributes_OnCommand" />
                    </ItemTemplate>
                </asp:TemplateField>
