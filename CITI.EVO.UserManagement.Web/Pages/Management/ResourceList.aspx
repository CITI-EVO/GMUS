    ...
    <asp:UpdatePanel runat="server" ID="upnlMain" UpdateMode="Always">
        <ContentTemplate>
                              ...
                              პროექტების ჩამონათვალი
                                    ...
                                    <ce:ImageLinkButton ID="btnSearch" runat="server" ToolTip="ძებნა" CssClass="btn btn-primary fa fa-search" OnClick="btSearch_OnClick" />

                                    <ce:ImageLinkButton ID="btNew" runat="server" ToolTip="რესურსის დამატება" CssClass="btn btn-primary fa fa-plus" OnClick="btnNew_OnClick" />
